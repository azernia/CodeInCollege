<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReaderHeadmodule.ascx.cs" Inherits="Library.UserControl.ReaderHeadmodule" %>
<!--BEGIN HEADER MODULE-->
<script>
	var linksrcTop;
	var linksrcLeft;
	...
	function showMenu(menu,tableW)
	{
		switch (menu)
		{
			...
			case '2' :mArray = new Array('图书信息查询');mArrayURL = new Array('<%# UrlBase + "/Reader/bookQuery.aspx"%>');break;
			case '3' :mArray = new Array('查看借阅信息');mArrayURL = new Array('<%# UrlBase + "/Reader/bookBorrowInfo.aspx"%>');break;
			case '4' :mArray = new Array('修改密码');mArrayURL = new Array('<%# UrlBase + "/Reader/changePassword.aspx"%>','<%# UrlBase + "/about.html"%>');break;
		}
...
<table class="tbl" id="Table2" cellSpacing="0" cellPadding="0" width="760" border="0">
	<tr>
		<td background='<%# UrlBase + "/images/titl_bg.jpg"%>' height="26" align="right">
			...
			<A onclick="showMenu('3',100)" style="COLOR: black" href="#"><font color="#ffffff">借阅信息管理</font></A>&nbsp;<font color="#ffffff">┊</font>&nbsp;
			<A onclick="showMenu('4',100)" style="COLOR: black" href="#"><font color="#ffffff">系统管理</font></A>&nbsp;<font color="#ffffff">┊</font>&nbsp;
