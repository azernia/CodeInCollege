<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bookReturn.aspx.cs" Inherits="Admin_bookReturn" %>
...
<body>
   <form method="post" id="frmAnnounce" runat="server">
	  ...
	  <td style="height: 15px" align="center">
          <img src="../images/ADD.gif" width=14px height=14px>图书借阅管理--&gt;图书归还</td>
        </tr>
         <tr>
	    ...
	    <td style="height: 26px" align="center">
            <asp:Label ID="Result" runat="server" Width="510px" ForeColor="Red"></asp:Label></td>
        </tr>
          <tr>
              <td style="height: 26px" align="center">
                  <asp:Button ID="Btn_Add" runat="server" OnClick="Btn_Add_Click" Text="归还" />&nbsp;
