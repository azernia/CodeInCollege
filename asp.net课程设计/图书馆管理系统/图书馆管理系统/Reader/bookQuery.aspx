<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bookQuery.aspx.cs" Inherits="Reader_bookQuery" %>
              ...
              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                  ...
                  <Columns>
                      ...
                      <asp:TemplateField HeaderText="详细信息">
                          <ItemTemplate>
                            <a href='bookDetails.aspx?bookId=<%# Eval("bookId") %>'><img src="../images/edit.gif" width=12px height=12px border=0px>详细信息</a>
                          </ItemTemplate>
                      </asp:TemplateField>
                  </Columns>
